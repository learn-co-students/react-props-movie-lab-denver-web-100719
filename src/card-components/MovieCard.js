  ...
  render() {
    ...
    return (
      <div className="movie-card">
        ...
        <CardFront poster={posterMap[poster]} title={title} IMDBRating={IMDBRating} genres={genres} />
        <CardBack poster={posterMap[poster]} title={title} IMDBRating={IMDBRating} genres={genres} />
      </div>
    )
  }
}
